										...
										<div class="card bg-transparent rounded-0 shadow-none">
											<div class="card-body">
												<div class="steps steps-light">
													<a class="step-item active" href="{{ route('frontend.shop-cart') }}">
														<div class="step-progress"><span class="step-count">1</span>
														<div class="step-label"><i class='bx bx-cart'></i>Cart</div>
													</a>
													<a class="step-item active" href="{{ route('frontend.checkout-details') }}">
														<div class="step-progress"><span class="step-count">2</span>
														<div class="step-label"><i class='bx bx-user-circle'></i>Details</div>
													</a>
													<a class="step-item active" href="{{ route('frontend.checkout-shipping') }}">
														<div class="step-progress"><span class="step-count">3</span>
														<div class="step-label"><i class='bx bx-cube'></i>Shipping</div>
													</a>
													<a class="step-item active current" href="{{ route('frontend.checkout-payment') }}">
														<div class="step-progress"><span class="step-count">4</span>
														<div class="step-label"><i class='bx bx-credit-card'></i>Payment</div>
													</a>
													<a class="step-item" href="{{ route('frontend.checkout-review') }}">
															...
															<form>
																...
																<div class="mb-3">
																	...
																	<div class="input-group">
																		<input type="text" class="form-control rounded-0" placeholder="Valid Owner number">	<span class="input-group-text rounded-0"><img src="{{ asset('frontend/assets/images/icons/mastercard.png') }}" width="35" alt=""></span>
																		<span class="input-group-text rounded-0"><img src="{{ asset('frontend/assets/images/icons/visa.png') }}" width="35" alt=""></span>
																		<span class="input-group-text rounded-0"><img src="{{ asset('frontend/assets/images/icons/american-express.png') }}" width="35" alt=""></span>
																<div class="row">
													...
													<div class="card-body">
														...
														<div class="d-flex align-items-center">
															<a class="d-block flex-shrink-0" href="javascript:;">
																<img src="{{ asset('frontend/assets/images/products/01.png') }}" width="75" alt="Product">
															</a>
															<div class="ps-2">
														...
														<div class="d-flex align-items-center">
															<a class="d-block flex-shrink-0" href="javascript:;">
																<img src="{{ asset('frontend/assets/images/products/17.png') }}" width="75" alt="Product">
															</a>
															<div class="ps-2">
														...
														<div class="d-flex align-items-center">
															<a class="d-block flex-shrink-0" href="javascript:;">
																<img src="{{ asset('frontend/assets/images/products/04.png') }}" width="75" alt="Product">
															</a>
															<div class="ps-2">
														...
														<div class="d-flex align-items-center">
															<a class="d-block flex-shrink-0" href="javascript:;">
																<img src="{{ asset('frontend/assets/images/products/09.png') }}" width="75" alt="Product">
															</a>
															<div class="ps-2">
