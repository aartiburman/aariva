								...
								<thead>
									<tr>
										<th class="align-middle text-center">
											<p class="mb-0 text-uppercase fs-3">Product
												<br>Photo</p>
										</th>
										<th class="align-middle text-center">
											<img src="{{ asset('frontend/assets/images/products/22.png') }}" alt="" width="230">
										</th>
										<th class="align-middle text-center">
											<img src="{{ asset('frontend/assets/images/products/23.png') }}" alt="" width="230">
										</th>
									</tr>
								</thead>
								<tbody>
									...
									<tr>
										<td></td>
										<td><a href="javascript:;" class="btn btn-dark btn-ecomm">Add to Cart</a>
