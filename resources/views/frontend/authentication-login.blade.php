										...
										<div class="card-body">
											<div class="border p-4 rounded">
												<div class="text-center">
													<h3 class="">Sign in</h3>
													<p>Don't have an account yet? <a href="{{ route('frontend.authentication-register') }}">Sign up here</a>
													</p>
												<div class="d-grid">
												...
												<div class="form-body">
													<form class="row g-3">
														...
														<div class="col-md-6 text-end">	<a href="{{ route('frontend.authentication-forgot-password') }}">Forgot Password ?</a>
														<div class="col-12">
															<div class="d-grid">
