							...
							<div class="col-12 col-xl-9">
								<div class="product-wrapper">
									<div class="toolbox d-flex align-items-center mb-3 gap-2 border p-3">
										...
										<div>	<a href="{{ route('frontend.shop-grid-left-sidebar') }}" class="btn btn-light rounded-0"><i class='bx bxs-grid me-0'></i></a>
										</div>
										<div>	<a href="{{ route('frontend.shop-list-left-sidebar') }}" class="btn btn-white rounded-0"><i class='bx bx-list-ul me-0'></i></a>
										</div>
									</div>
									<div class="product-grid d-flex flex-column gap-4">
										...
										<div class="card rounded-0 border">
											...
											<div class="row g-0">
												<div class="col-md-4">
													<img src="{{ asset('frontend/assets/images/products/08.png') }}" class="w-100 p-3" alt="...">
												</div>
												<div class="col-md-8">
													<div class="card-body">
														<div class="product-info">
