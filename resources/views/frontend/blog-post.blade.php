            ...
            <div class="col-12 col-lg-9">
                <div class="blog-right-sidebar">
                    <div class="card mb-4 rounded-0 border shadow-none">
                        <img src="{{ asset('frontend/assets/images/posts/01.png') }}" class="card-img-top rounded-0" alt="">
                        <div class="card-body">
                            ...
                            <p>There are many variations of passages of Lorem Ipsum available, but the majority have suffered alteration in some form, by injected humour, or randomised words which don't look even slightly believable. If you are going to use a passage of Lorem Ipsum, you need to be sure there isn't anything embarrassing hidden in the middle of text.</p>	<a href="{{ route('frontend.blog-read') }}" class="btn btn-dark btn-ecomm">Read More <i class='bx bx-chevrons-right' ></i></a>
                    <div class="card mb-4 rounded-0 border shadow-none">
                        <img src="{{ asset('frontend/assets/images/posts/02.png') }}" class="card-img-top" alt="">
                        <div class="card-body">
                            <div class="list-inline">	<a href="javascript:;" class="list-inline-item"><i class='bx bx-user me-1'></i>By Admin</a>
                                <a href="javascript:;" class="list-inline-item"><i class='bx bx-comment-detail me-1'></i>16 Comments</a>
                                <a href="javascript:;" class="list-inline-item"><i class='bx bx-calendar me-1'></i>November 5, 2021</a>
                            ...
                            <p>There are many variations of passages of Lorem Ipsum available, but the majority have suffered alteration in some form, by injected humour, or randomised words which don't look even slightly believable. If you are going to use a passage of Lorem Ipsum, you need to be sure there isn't anything embarrassing hidden in the middle of text.</p>	<a href="{{ route('frontend.blog-read') }}" class="btn btn-dark btn-ecomm">Read More <i class='bx bx-chevrons-right' ></i></a>
                    <div class="card mb-4 rounded-0 border shadow-none">
                        <img src="{{ asset('frontend/assets/images/posts/03.png') }}" class="card-img-top" alt="">
                        <div class="card-body">
                            <div class="list-inline">	<a href="javascript:;" class="list-inline-item"><i class='bx bx-user me-1'></i>By Admin</a>
                                <a href="javascript:;" class="list-inline-item"><i class='bx bx-comment-detail me-1'></i>16 Comments</a>
                                <a href="javascript:;" class="list-inline-item"><i class='bx bx-calendar me-1'></i>November 5, 2021</a>
