												...
												<div class="row">
													...
													<div class="col-md-6">
														<div class="payment-mode">
															...
															<img src="{{ asset('frontend/assets/images/icons/visa.png') }}" width="150" class="p-2 border bg-light rounded" alt="">
										<div class="card rounded-0 shadow-none mb-3 border">
											<div class="card-body">
												<div class="row">
													<div class="col-md-6">
													...
													<div class="col-md-6">
														<div class="d-grid"><a href="{{ route('frontend.checkout-complete') }}" class="btn btn-outline-dark btn-ecomm">Complete Order<i class="bx bx-chevron-right"></i></a>
