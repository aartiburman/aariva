                    ...
                    <div class="card border-0 shadow-sm rounded-4 height-500px">
                         <div class="card-body">
                              <div class="d-flex justify-content-between align-items-center mb-4">
                                   ...
                                   <div class="btn-group btn-group-sm" id="performance-filter">
                                        <button type="button" class="btn btn-outline-light text-dark border" data-filter="all">ALL</button>
                                        <button type="button" class="btn btn-outline-light text-dark border" data-filter="1m">1M</button>
                                        <button type="button" class="btn btn-outline-light text-dark border" data-filter="6m">6M</button>
                                        <button type="button" class="btn btn-purple active" style="background-color: #5d1a8f; color: white;" data-filter="1y">1Y</button>
                                   </div>
                              </div> <!-- end card-title-->
                              ...
                              <div dir="ltr">
                                   <div id="dash-performance-chart" 
                                        class="apex-charts" 
                                        data-series='@json($chartRevenue)' 
                                        data-months='@json($chartMonths)' 
                                        data-currency="{{ $currency }}"
                                        data-url="{{ route('vendor.performance.data') }}">
                                   </div>
                              </div>
                         </div> <!-- end card body -->
                    </div> <!-- end card -->
