    ...
    <div class="container-fluid">
        ...
        <div class="row">
            <div class="col-xl-12">
                <div class="card">
                    <div class="card-body">
                        <form action="{{ route('product.report') }}" method="POST" class="row g-2 align-items-end" id="product-report-filter-form">
                            @csrf
                            <button type="submit" style="display: none;"></button>
                            <div class="col-xl col-md-4 col-sm-6">
                                <label class="form-label fw-semibold fs-13 mb-1">Search</label>
                                <div class="position-relative">
                                    <input type="text" name="search" id="product-report-search" class="form-control form-control-sm ps-3 pe-5 py-2" placeholder="Search..." value="{{ request('search') }}">
...
<script>
    $(document).ready(function() {
        if (typeof initProductReport === 'function') {
            initProductReport();
        }
    });
</script>
