                                     ...
                                     <tr id="row_{{ $sizes[0]->id }}">
                                         ...
                                         <td>
                                             <div class="form-check form-switch">
                                                 <input class="form-check-input change-product-size-category-status" type="checkbox" role="switch" id="status_{{ $sizes[0]->id }}" data-id="{{ $sizes[0]->id }}" {{ $sizes[0]->status == 1 ? 'checked' : '' }}>
                                             </div>
                                         </td>
