                            ...
                            <table class="table datatables" id="pc-dt-filter">
                                ...
                                <tbody>
                                    ...
                                    <tr id="row_{{ $value->id }}">
                                        ...
                                        <td>
                                            <span class="toggle-variant cursor-pointer"
                                                data-id="{{ $value->id }}">
                                                <strong>{{ $value->name }}</strong>
                                            ...
                                            <div class="variant-row d-none mt-3" id="variant_{{ $value->id }}">
                                                ...
                                                <div class="variant-card mb-3 p-3 border rounded bg-light">
                                                    ...
                                                    <div class="row">
                                                        ...
                                                        <div class="col-md-6">
                                                            ...
                                                            <p class="mb-0">
                                                                <strong>Final Price:</strong> {{ $variant->final_price }}
                                                            </p>
                                                        </div>
                                                    </div>

                                                    @if(count($images))
                                                    <div class="variant-images mt-2 d-flex gap-2">
                                                        @foreach ($images as $img)
                                                        <img src="{{ asset('uploads/products/'.$img) }}"
                                                            class="variant-thumb rounded"
                                        ...
                                        <td>
                                            <select class="form-select form-select-sm change-product-status"
                                                data-id="{{ $value->id }}">
