            ...
            <div class="col-xl-12">
                <div class="card">
                    ...
                    <div class="card-body">
                        ...
                        <form id="bulkUploadForm" method="POST" action="{{ route('bulk.upload.product.store') }}" enctype="multipart/form-data" class="needs-validation" novalidate>
                            @csrf
                            ...
                            <div class="row">
                                        ...
                                        <div class="card-body p-3">
                                            <div class="row g-3">
                                                <div class="col-md-4">
                                                    ...
                                                    <select name="category_id" class="form-select form-select-sm category_id dynamic-create" data-allow-new="true" data-type="category" data-placeholder="Create or select Category">
                                                ...
                                                <div class="col-md-4">
                                                    ...
                                                    <select name="subcategory_id" class="form-select form-select-sm subcategory_id dynamic-create" data-allow-new="true" data-type="subcategory" data-placeholder="Create or select Subcategory"></select>
                                                </div>
                                                <div class="col-md-4">
                                                    <label class="form-label fw-semibold fs-13">Child Category</label>
                                                    <select name="child_category_id" class="form-select form-select-sm child_category_id dynamic-create" data-allow-new="true" data-type="childcategory" data-placeholder="Create or select Child category"></select>
                                                </div>
                                                <div class="col-md-12">
                                                    <label class="form-label fw-semibold fs-13">Brand</label>
                                                    <select name="brand_id" class="form-select form-select-sm categoryBrand dynamic-create" data-allow-new="true" data-type="brand" data-placeholder="Create or select Brand">
                                            ...
                                            <div class="row g-3">
                                                <div class="col-md-6">
                                                    <label class="form-label fw-semibold fs-13">Apply Offers</label>
                                                ...
                                                <div class="col-12">
                                                    <div class="form-check form-switch">
                                                        ...
                                                        <label class="form-check-label fs-13 fw-semibold cursor-pointer" for="featured">Mark all products as Featured</label>
                                                    </div>
                                                </div>
                                            </div>
                                        </div>
                                ...
                                <div class="col-lg-4">
                                    <div class="card border-0 shadow-sm mb-4 h-100">
                                        <div class="card-header bg-light-subtle py-2">
                                            <h6 class="card-title mb-0 text-uppercase fw-bold fs-13 text-primary">Step 2: Upload File</h6>
                                        </div>
                                        <div class="card-body p-3 d-flex flex-column">
                                            <div class="mb-4">
                                                <label class="form-label fw-semibold fs-13">Upload CSV File <span class="text-danger">*</span></label>
                                                <div class="upload-container p-4 border border-dashed rounded text-center bg-light-subtle position-relative">
                                                    ...
                                                    <h6 class="fs-14 mb-1 fw-bold">Click to browse or drag file</h6>
                                            ...
                                            <div class="mt-auto">
                                                ...
                                                <button type="submit" class="btn btn-primary w-100 py-2 d-flex align-items-center justify-content-center gap-2 no-loader" id="submit-btn">
                                                    <iconify-icon icon="solar:upload-linear" class="fs-20"></iconify-icon>
                                                    <span class="fw-bold">START IMPORT</span>
                                                </button>
                                            </div>
                                        </div>
                                    </div>
                ...
                <div class="card">
                        ...
                        <div class="mt-4 {{ (request('vendor_id') || request('is_active') !== null || request('date_range')) ? 'show' : '' }}">
                            <div class="card border shadow-none mb-4">
                                <div class="card-body">
                                    <form action="{{ route('bulk.upload.product') }}" method="POST" id="filter-form">
                                        @csrf
                        ...
                        <div class="card border shadow-none mt-4">
                            <div class="card-header bg-light-subtle d-flex justify-content-between align-items-center py-2">
                                ...
                                <div class="d-flex align-items-center gap-2">
                                    ...
                                    <button id="export-selected-btn" class="btn btn-sm btn-outline-secondary gap-1 d-none">
                                        <iconify-icon icon="solar:download-linear" class="fs-18"></iconify-icon> Export Selected
                                    </button>

                                    <a href="{{ route('export.bulk.products', request()->all()) }}" class="btn btn-sm btn-outline-secondary gap-1" id="export-all-btn">
                                        <iconify-icon icon="solar:download-linear" class="fs-18"></iconify-icon> Export All
                                    </a>
                            ...
                            <div class="card-footer border-top bg-light-subtle">
                                <div class="d-flex align-items-center justify-content-between">
                                    ...
                                    <a href="{{ route('product.list') }}" class="btn btn-sm btn-primary">View All Products</a>
                                </div>
                            </div>
                        </div>
                </div>
        ...
        <script>
            $(document).ready(function() {
                ...
                $('#bulkUploadForm').on('submit', function() {
                    ...
                    // Use .empty() before .append() to ensure button is clear
                    btn.empty().append('<span class="spinner-border spinner-border-sm me-1" role="status" aria-hidden="true"></span>').append('<span class="fw-bold">PROCESSING UPLOAD...</span>');
                });
                ...
                function toggleBulkDeleteBtn() {
                    ...
                    if (selectedCount > 0) {
                        ...
                        $('#export-selected-btn').removeClass('d-none');
                        $('#export-all-btn').addClass('d-none');
                    } else {
                        bulkDeleteBtn.addClass('d-none');
                        $('#export-selected-btn').addClass('d-none');
                        $('#export-all-btn').removeClass('d-none');
                    }
                }
                ...
                $('#export-selected-btn').on('click', function() {
                    ...
                    if (ids.length > 0) {
                        const baseUrl = "{{ route('export.bulk.products') }}";
                        const params = $.param({ ids: ids });
