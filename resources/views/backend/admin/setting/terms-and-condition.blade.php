            ...
            <div class="col-xl-12">
                <div class="card">
                    <div class="card-header d-flex justify-content-between align-items-center gap-1">
                        <h4 class="card-title flex-grow-1">Terms & Conditions List</h4>
                    </div>
                        ...
                        <div class="table-responsive">
                            <table class="table align-middle mb-0 table-hover table-centered">
                                ...
                                <tbody>
                                    ...
                                    <tr>
                                        <td class="ps-4">
                                            <h6 class="mb-0 fw-bold text-dark fs-14">{{ $term->title }}</h6>
                                        </td>
                                        <td>
                                            @if($term->status == 1)
                                        ...
                                        <td class="fs-13 text-muted">{{ $term->created_at->format('M d, Y') }}</td>
                                        <td class="pe-4 text-center">
                                            <div class="d-flex justify-content-center gap-2">
                                                <a href="{{ route('term.and.conditions.edit', $term->id) }}" class="text-purple hover-opacity-100" data-bs-toggle="tooltip" title="Edit">
                                    ...
                                    <tr>
                                        <td colspan="4" class="text-center py-5">
                                            <div class="d-flex flex-column align-items-center">
                                                ...
                                                <h6 class="text-muted">No terms and conditions found</h6>
                                            </div>
                                        </td>
                                    </tr>
                                    @endforelse
                    ...
                    <div class="card-footer border-top">
                        {{ $terms->appends(request()->query())->links('pagination::bootstrap-5') }}
                    </div>
                    @endif
                </div>
            </div>
    ...
    function deleteTerm(id) {
        Swal.fire({
            ...
            if (result.isConfirmed) {
                $.ajax({
                    url: "{{ route('term.and.conditions.delete') }}",
                    type: "POST",
                    data: {
                        id: id,
                        _token: "{{ csrf_token() }}"
