     ...
     <div class="pc-content">
                         ...
                         <div class="row align-items-center">
                             ...
                             <div class="col-md-12">
                                 <ul class="breadcrumb mb-0">
                                     ...
                                     <li class="breadcrumb-item" aria-current="page">Pending Orders List</li>
                                 </ul>
                             </div>
                         </div>
                     </div>
         ...
         <div class="row">
             ...
             <div class="col-xl-12">
                 ...
                 <div class="card">
                     <div class="card-header">
                        <h5 style="display:inline-block;">Pending Orders List</h5>


                        <a href="{{route('add.subcategory')}}" class="btn btn-success d-inline-flex" style="float:right;color: white;">
                            <iconify-icon icon="solar:plus-linear" class="me-1"></iconify-icon>Add Pending Orders</a>
                    </div>
