        ...
        <div class="row">
            ...
            <div class="col-xl-12">
                <div class="card border-0 shadow-sm">
                    ...
                    <div class="card-body">
                        <form id="CategoryForm" action="{{ route('update.category') }}" method="POST" enctype="multipart/form-data">
                            @csrf
                            ...
                            <div class="row">
                                 <div class="col-md-12 mb-4">
                                    <div class="mb-4">
                                        ...
                                        <img  src="{{ asset($cat_data->image) }}" alt="Preview" width="80" class="img-thumbnail mt-2 imagePreview">
                                ...
                                <div class="col-md-6 mb-3">
                                    ...
                                    <input type="text" name="name" class="form-control" placeholder="Enter Title" required id="nameInput" value="{{ $cat_data->name }}">
                                </div>

                                <!-- Slug (Auto-generated) -->
                                <div class="col-md-6 mb-3">
                                    <label class="form-label">Slug</label>
                                    <input type="text" name="slug" class="form-control" placeholder="Auto-generated slug" readonly id="slugInput" value="{{ $cat_data->slug }}">
                                </div>

                                <!-- Description -->
                                <div class="col-md-12 mb-3">
                                    <label class="form-label">Description</label>
                                    <textarea name="description" class="form-control" rows="4" placeholder="Type Description">{{ $cat_data->description }}</textarea>
                                </div>
                            </div>
                            ...
                            <div class="row mt-3">
                                ...
                                <div class="col-md-6 mb-3">
                                    ...
                                    <input type="text" name="meta_title" class="form-control" placeholder="Enter Meta Title" value="{{ $cat_data->meta_title }}">
                                </div>

                                <!-- Meta Description -->
                                <div class="col-md-6 mb-3">
                                    <label class="form-label">Meta Description</label>
                                    <textarea name="meta_description" class="form-control" rows="1" placeholder="Type Meta Description">{{ $cat_data->meta_description }}</textarea>
                                </div>
                            </div>
                            ...
                            <div class="mb-4 mt-2">
                                <div class="form-check form-switch">
                                    <input class="form-check-input form-switch-gold" type="checkbox" name="is_active" id="isActive" value="1" {{ $cat_data->is_active ? 'checked' : '' }}>
