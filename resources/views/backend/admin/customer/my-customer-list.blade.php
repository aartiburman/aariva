    ...
    <div class="container-fluid">
        ...
        <div class="card border-0 shadow-sm mb-4">
            <div class="card-header border-0 p-4">
                <form action="{{ route('my.customer.list') }}" method="POST" id="customer-filter-form">
                    @csrf
                    <div class="row align-items-end g-2">
                        <div class="col-md-5">
                            <label class="form-label fw-semibold fs-13 mb-1">Search Customer</label>
                            <div class="input-group input-group-sm">
                                <input type="text" name="search" id="customer-search" class="form-control" placeholder="Search by name, email, phone..." value="{{ request('search') }}">
                        ...
                        <div class="col-md-2">
                            ...
                            <select name="state_id" id="state_id" class="form-select form-select-sm state_id"  onchange="this.form.submit()">
                                <option value="">All States</option>
                            </select>
                        </div>
                        <div class="col-md-2">
                            <label class="form-label fw-semibold fs-13 mb-1">City</label>
                            <select name="city_id" id="city_id" class="form-select form-select-sm city_id"  onchange="this.form.submit()">
                                <option value="">All Cities</option>
                            </select>
                        </div>
                        <div class="col-md-1">
                            <a href="{{ route('my.customer.list') }}" class="btn btn-sm btn-outline-secondary w-100">Reset</a>
                        </div>
                    </div>
                </form>
            </div>
            ...
            <div class="col-xl-12">
                <div class="card border-0 shadow-sm">
                    <div class="card-header d-flex justify-content-between align-items-center gap-1">
                        <h4 class="card-title flex-grow-1">My Customer List</h4>

                        <div class="d-flex align-items-center gap-2">
                            <a href="{{ route('export.my.customers', request()->all()) }}" class="btn btn-sm btn-outline-secondary">
