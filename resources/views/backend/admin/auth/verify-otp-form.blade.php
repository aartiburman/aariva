            ...
            <div class="col-lg-6 py-lg-3  card">
              <div class="d-flex flex-column h-100 justify-content-center">
                ...
                <div class="text-center ">
                    <img class="logo auth-logo logo-dark-theme" src="{{ $darkLogo }}" alt="logo" height="50">
                    <img class="logo auth-logo logo-light-theme" src="{{ $lightLogo }}" alt="logo" height="50">
                              </div>
              ...
              <div class="card-body">
                ...
                <p class="text-center text-muted mb-4">Please check your email. We've sent a 6-digit verification code to <strong class="text-primary">{{ session('reset_email') }}</strong></p>
                <div class="mb-3">
                  <input type="text" class="form-control" id="floatingInput" placeholder="Enter The Otp" name="otp" value="{{ old('otp') }}">
                </div>


                <div class="text-center mt-4">
                  <button type="submit" class="btn btn-primary shadow px-sm-4">Verify Otp</button>
                </div>
