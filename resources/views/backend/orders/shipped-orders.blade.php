...
<div class="page-content">
    ...
    <div class="container-fluid">
        ...
        <div class="row g-2 flex-nowrap overflow-auto pb-3">
                ...
                <a href="{{ route('shipped.orders') }}" class="text-decoration-none">
                    <div class="card mb-0">
                        <div class="card-body p-2 border border-primary rounded">
                            <div class="d-flex align-items-center justify-content-between">
                                <div>
                                    <h5 class="card-title mb-1 fs-13 text-primary">Shipped</h5>
                                    <p class="text-primary fw-bold fs-16 mb-0">{{ $statusCounts->shipped ?? 0 }}</p>
                                </div>
            ...
            <div class="col-xl-12">
                @include('backend.orders.partials._filters', ['title' => 'Shipped Orders List', 'use_ajax' => true])
