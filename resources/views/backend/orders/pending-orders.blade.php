        ...
        <div class="row g-2 flex-nowrap overflow-auto pb-3">
            ...
            <div class="col">
                <a href="{{ route('pending.orders') }}" class="text-decoration-none">
                    <div class="card mb-0">
                        <div class="card-body p-2 border border-primary rounded">
                            <div class="d-flex align-items-center justify-content-between">
                                <div>
                                    <h5 class="card-title mb-1 fs-13 text-primary">Pending</h5>
                                    <p class="text-primary fw-bold fs-16 mb-0">{{ $statusCounts->pending ?? 0 }}</p>
                                </div>
                                <div class="avatar-sm bg-soft-primary rounded">
                                    <iconify-icon icon="solar:clock-circle-linear" class="avatar-title fs-20 text-primary"></iconify-icon>
                                </div>
                            </div>
                        </div>
                    </div>
            ...
            <div class="col-xl-12">
                @include('backend.orders.partials._filters', ['title' => 'Pending Orders List', 'use_ajax' => true])
