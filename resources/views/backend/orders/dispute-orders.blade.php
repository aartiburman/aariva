...
<div class="page-content">
    ...
    <div class="container-fluid">
        ...
        <div class="row mt-2">
            <div class="col-xl-12">
                <div class="page-title-box">
                    <h4 class="mb-0 fs-18">In Dispute Orders List</h4>
                </div>
            </div>
        </div>
                        ...
                        <div class="card-body p-2">
                            <div class="d-flex align-items-center justify-content-between">
                                <div>
                                    ...
                                    <p class="text-muted fw-bold fs-16 mb-0">{{ $statusCounts->pending ?? 0
        ...
        <div class="row">
            <div class="col-xl-12">
                @include('backend.orders.partials._filters', ['title' => 'In Dispute Orders', 'use_ajax' => true])
                
                <div class="card">
                    <div class="card-header border-bottom-0">
                        <div class="d-flex align-items-center justify-content-between">
                            <h4 class="card-title mb-0">In Dispute Orders</h4>
                        </div>
                    </div>
