        ...
        <div class="row g-2 flex-nowrap overflow-auto pb-3">
            ...
            <div class="col">
                <a href="{{ route('confirmed.orders') }}" class="text-decoration-none">
                    <div class="card mb-0">
                        <div class="card-body p-2 border border-info rounded">
                            <div class="d-flex align-items-center justify-content-between">
                                <div>
                                    <h5 class="card-title mb-1 fs-13 text-info">Confirmed</h5>
                                    <p class="text-info fw-bold fs-16 mb-0">{{ $statusCounts->confirmed ?? 0 }}</p>
                                </div>
            ...
            <div class="col-xl-12">
                @include('backend.orders.partials._filters', ['title' => 'Confirmed Orders List', 'use_ajax' => true])
                
                <div class="card">
                    <div class="card-header border-bottom-0">
                        <div class="d-flex align-items-center justify-content-between">
                            <h4 class="card-title mb-0">Confirmed Orders List</h4>
                        </div>
                    </div>
