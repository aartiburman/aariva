        ...
        <div class="row g-2 flex-nowrap overflow-auto pb-3">
            ...
            <div class="col">
                <a href="{{ route('delivered.orders') }}" class="text-decoration-none">
                    <div class="card mb-0">
                        <div class="card-body p-2 border border-success rounded">
                            <div class="d-flex align-items-center justify-content-between">
                                <div>
                                    <h5 class="card-title mb-1 fs-13 text-success">Delivered</h5>
                                    <p class="text-success fw-bold fs-16 mb-0">{{ $statusCounts->delivered ?? 0 }}</p>
                                </div>
            ...
            <div class="col-xl-12">
                @include('backend.orders.partials._filters', ['title' => 'Delivered Orders List', 'use_ajax' => true])
