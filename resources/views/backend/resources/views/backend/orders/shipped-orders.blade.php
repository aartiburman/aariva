...
<div class="page-content">
    ...
    <div class="container-fluid">
        ...
        <div class="row">
            <div class="col-xl-12">
                <div class="page-title-box">
                    <h4 class="mb-0 fs-18">Shipped Orders List</h4>
                </div>
            </div>
        </div>

        <div class="row row-cols-xxl-6 row-cols-xl-6 row-cols-lg-4 row-cols-md-3 row-cols-1 g-2">
            <!-- All Orders -->
            <div class="col">
        ...
        <div class="row">
            <div class="col-xl-12">
                @include('backend.orders.partials._filters', ['title' => 'Shipped Orders List', 'hide_status_filter' => true])
                
                <div class="card">
                    <div class="card-header border-bottom-0">
                        <div class="d-flex align-items-center justify-content-between">
                            <h4 class="card-title mb-0">Shipped Orders List</h4>
                        </div>
                    </div>
