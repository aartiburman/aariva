        ...
        <div class="row">
            <div class="col-xl-12">
                <div class="page-title-box">
                    <h4 class="mb-0 fs-18">Confirmed Orders List</h4>
                </div>
            </div>
        </div>
...
<!-- Returned -->
        ...
        <div class="row">
            <div class="col-xl-12">
                @include('backend.orders.partials._filters', ['title' => 'Confirm Orders List', 'hide_status_filter' => true])
                
                <div class="card">
                    <div class="card-header border-bottom-0">
                        <div class="d-flex align-items-center justify-content-between">
                            <h4 class="card-title mb-0">Confirm Orders List</h4>
                        </div>
                    </div>
