...
<div class="page-content">
    ...
    <div class="container-fluid">
        ...
        <div class="row">
            <div class="col-xl-12">
                <div class="page-title-box">
                    <h4 class="mb-0 fs-18">Cancelled Orders List</h4>
                </div>
            </div>
        </div>
                        ...
                        <div class="card-body">
                            <div class="d-flex align-items-center justify-content-between">
                                ...
                                <div class="avatar-md bg-soft-success rounded">
                                    <iconify-icon icon="solar:check-circle-linear" class="avatar-title fs-32 text-success"></iconify-icon>
                                </div>
                            </div>
                        </div>
                    </div>
        ...
        <div class="row">
            <div class="col-xl-12">
                @include('backend.orders.partials._filters', ['title' => 'Cancelled Orders List', 'hide_status_filter' => true])
                
                <div class="card">
                    <div class="card-header border-bottom-0">
                        <div class="d-flex align-items-center justify-content-between">
                            <h4 class="card-title mb-0">Cancelled Orders List</h4>
                        </div>
                    </div>
                        ...
                        <div class="table-responsive">
                            <table class="table align-middle table-nowrap table-hover mb-0">
                                ...
                                <tbody>
                                    ...
                                    <tr>
                                        <td><a href="javascript:void(0);" class="fw-medium">#{{ $item->order->order_reference_id }}</a></td>
                                        ...
                                        <td>{{ $item->quantity }}</td>
                                        <td>#{{ $item->order->delivery_number ?? 'N/A' }}</td>
                                        <td>
                                            @php
