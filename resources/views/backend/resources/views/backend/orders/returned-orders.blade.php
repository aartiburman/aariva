...
<div class="page-content">
    ...
    <div class="container-fluid">
                    ...
                    <div class="card">
                        <div class="card-body">
                            <div class="d-flex align-items-center justify-content-between">
                                <div>
                                    <h4 class="card-title mb-1 fs-13">All Orders</h4>
                                    <p class="text-muted fw-medium fs-22 mb-0">{{ $statusCounts->total ?? 0 }}</p>
                                </div>
                                <div class="avatar-md bg-soft-primary rounded">
                                    <iconify-icon icon="solar:clipboard-list-linear" class="avatar-title fs-32 text-primary"></iconify-icon>
                                </div>
                            </div>
                        </div>
                    </div>
                ...
                <a href="{{ route('pending.orders') }}" class="text-decoration-none">
                    <div class="card">
                        <div class="card-body">
                            <div class="d-flex align-items-center justify-content-between">
                                <div>
                                    <h4 class="card-title mb-1 fs-13">Pending</h4>
                                    <p class="text-muted fw-medium fs-22 mb-0">{{ $statusCounts->pending ?? 0 }}</p>
                                </div>
                                <div class="avatar-md bg-soft-warning rounded">
                                    <iconify-icon icon="solar:clock-circle-linear" class="avatar-title fs-32 text-warning"></iconify-icon>
                                </div>
                            </div>
                        </div>
                    </div>
                ...
                <a href="{{ route('confirmed.orders') }}" class="text-decoration-none">
                    <div class="card">
                        <div class="card-body">
                            <div class="d-flex align-items-center justify-content-between">
                                <div>
                                    <h4 class="card-title mb-1 fs-13">Confirmed</h4>
                                    <p class="text-muted fw-medium fs-22 mb-0">{{ $statusCounts->confirmed ?? 0 }}</p>
                                </div>
                                <div class="avatar-md bg-soft-info rounded">
                                    <iconify-icon icon="solar:check-circle-linear" class="avatar-title fs-32 text-info"></iconify-icon>
                                </div>
                            </div>
                        </div>
                    </div>
                ...
                <a href="{{ route('shipped.orders') }}" class="text-decoration-none">
                    <div class="card">
                        <div class="card-body">
                            <div class="d-flex align-items-center justify-content-between">
                                <div>
                                    <h4 class="card-title mb-1 fs-13">Shipped</h4>
                                    <p class="text-muted fw-medium fs-22 mb-0">{{ $statusCounts->shipped ?? 0 }}</p>
                                </div>
                                <div class="avatar-md bg-soft-primary rounded">
                                    <iconify-icon icon="solar:box-linear" class="avatar-title fs-32 text-primary"></iconify-icon>
                                </div>
                            </div>
                        </div>
                    </div>
                ...
                <a href="{{ route('delivered.orders')}}" class="text-decoration-none">
                    <div class="card">
                        <div class="card-body">
                            <div class="d-flex align-items-center justify-content-between">
                                <div>
                                    <h4 class="card-title mb-1 fs-13">Delivered</h4>
                                    <p class="text-muted fw-medium fs-22 mb-0">{{ $statusCounts->delivered ?? 0 }}</p>
                                </div>
                                <div class="avatar-md bg-soft-primary rounded">
                                    <iconify-icon icon="solar:check-circle-linear" class="avatar-title fs-32 text-primary"></iconify-icon>
                                </div>
                            </div>
                        </div>
                    </div>
                ...
                <a href="{{ route('cancelled.orders') }}" class="text-decoration-none">
                    <div class="card">
                        <div class="card-body">
                            <div class="d-flex align-items-center justify-content-between">
                                <div>
                                    <h4 class="card-title mb-1 fs-13">Cancelled</h4>
                                    <p class="text-muted fw-medium fs-22 mb-0">{{ $statusCounts->cancelled ?? 0 }}</p>
                                </div>
                                <div class="avatar-md bg-soft-danger rounded">
                                    <iconify-icon icon="solar:close-circle-linear" class="avatar-title fs-32 text-danger"></iconify-icon>
                                </div>
                            </div>
                        </div>
                    </div>
                ...
                <a href="{{ route('returned.orders') }}" class="text-decoration-none">
                    <div class="card">
                        <div class="card-body">
                            <div class="d-flex align-items-center justify-content-between">
                                <div>
                                    <h4 class="card-title mb-1 fs-13">Returned</h4>
                                    <p class="text-muted fw-medium fs-22 mb-0">{{ $statusCounts->returned ?? 0 }}</p>
                                </div>
                                <div class="avatar-md bg-soft-warning rounded">
                                    <iconify-icon icon="solar:arrow-return-linear" class="avatar-title fs-32 text-warning"></iconify-icon>
                                </div>
                            </div>
                        </div>
                    </div>
        ...
        <div class="row">
            <div class="col-xl-12">
                @include('backend.orders.partials._filters', ['title' => 'Returned Orders List', 'hide_status_filter' => true])
                                ...
                                <tbody>
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            <!-- Badge -->
                                            <span
                                                class="badge payment-status-badge {{ ($item->payment_status ?? 0) == 1 ? 'bg-soft-primary text-primary' : 'bg-soft-danger text-danger' }}"
                                        ...
                                        <td>
                                            ...
                                            if($order_status_val == '3') $statusClass = 'bg-soft-primary text-primary';
