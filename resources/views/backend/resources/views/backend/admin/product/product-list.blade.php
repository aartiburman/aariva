...
<div class="page-content">
    ...
    <div class="container-fluid">
                        ...
                        <div class="card-body p-4">
                            <div class="d-flex align-items-start justify-content-between">
                                <div>
                                    ...
                                    <h2 class="text-dark mb-2 fw-bold">{{ $statusCounts->total ?? 0 }}</h2>
                                    <div class="mt-4">
                        ...
                        <div class="card-body p-4">
                            <div class="d-flex align-items-start justify-content-between">
                                <div>
                                    ...
                                    <h2 class="text-dark mb-2 fw-bold">{{ $statusCounts->pending ?? 0 }}</h2>
                                    <div class="mt-4">
                        ...
                        <div class="card-body p-4">
                            <div class="d-flex align-items-start justify-content-between">
                                <div>
                                    ...
                                    <h2 class="text-dark mb-2 fw-bold">{{ $statusCounts->approved ?? 0 }}</h2>
                                    <div class="mt-4">
                        ...
                        <div class="card-body p-4">
                            <div class="d-flex align-items-start justify-content-between">
                                <div>
                                    ...
                                    <h2 class="text-dark mb-2 fw-bold">{{ $statusCounts->rejected ?? 0 }}</h2>
                                    <div class="mt-4">
        ...
        <div class=" {{ (request('search') || request('date_range') || request('is_active') !== null || request('status') !== null) ? 'show' : '' }}">
                        ...
                        <div class="row align-items-end g-2">
                            ...
                            <div class="col-md-2">
                                ...
                                <div class="col-md-2">
                                    ...
                                    <select name="brand_id" class="form-select form-select-sm select2" onchange="$('#filter-form').submit()">
                                ...
                                <div class="col-md-2">
                                    ...
                                    <select name="vendor_id" class="form-select form-select-sm select2" onchange="$('#filter-form').submit()">
                                ...
                                <div class="col-md-2">
                                    ...
                                    <select name="is_active" class="form-select form-select-sm" onchange="$('#filter-form').submit()">
                ...
                <div class="card">
                    <div class="card-header d-flex justify-content-between align-items-center gap-1">
                        ...
                        <div class="d-flex align-items-center gap-2">
                            ...
                            <button type="button" id="product_bulk_export_btn" class="btn btn-sm btn-outline-secondary d-none">
    ...
    <script>
          $(document).ready(function() {
                ...
                initAjaxFilter('#filter-form', 'tbody', '.card-footer p', 'products');
                
                // Initialize Bulk Delete
                initBulkDelete('.row-checkbox', '#bulk-delete-btn', "{{ route('bulk.delete.product') }}");
                
                // Initialize Product List (Variant Toggle, Status Change)
                initProductList();
                ...
                $(document).on('change', '.row-checkbox', function() {
                    ...
                    if (checked > 0) {
                        $('#product_bulk_active_btn, #product_bulk_deactive_btn, #product_bulk_export_btn').show().removeClass('d-none');
                    } else {
                        $('#product_bulk_active_btn, #product_bulk_deactive_btn, #product_bulk_export_btn').hide().addClass('d-none');
                    }
                });
                ...
                // Bulk Export
                $('#product_bulk_export_btn').on('click', function() {
                    var ids = $('.row-checkbox:checked').map(function() {
                        return $(this).val();
                    }).get();
    
                    var form = $('<form>', {
                        action: "{{ route('export.products') }}",
                        method: "POST",
                        class: "no-loader"
                    });
