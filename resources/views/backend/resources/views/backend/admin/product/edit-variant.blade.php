    ...
    <div class="container-fluid">
           ...
           <div class="row">
                                    ...
                                    <form id="editVariantsForm"
                                              ...
                                              <div class="variant-block border p-3 mb-4 rounded text-start">
                                                   ...
                                                   <div class="row">
                                                        ...
                                                        <div class="col-md-4 mb-3">
                                                             ...
                                                             <select name="discount_type[{{ $index }}]"
                                                                  class="form-control ve-discount-type">
                                                                  <option value="">None</option>
                                                                  <option value="off" {{ in_array($value->discount_type, ['off', 'flat']) ? 'selected' : '' }}>Flat</option>
                                                                  <option value="%" {{ in_array($value->discount_type, ['%', 'percent']) ? 'selected' : '' }}>%</option>
                                                             </select>
                                                        </div>
                                                        ...
                                                        <div class="col-md-4 mb-3">
                                                             ...
                                                             <input type="text"
                                                                  name="discount_value[{{ $index }}]"
                                                                  class="form-control ve-discount-value"
                                                        ...
                                                        <div class="col-md-6 mb-3">
                                                             ...
                                                             <select name="size_category_id[{{ $index }}]"
                                                        ...
                                                        <div class="col-md-6 mb-3">
                                                             ...
                                                             <select name="size[{{ $index }}][]"
                                                                  class="form-control js-size-select"
                                                                  multiple>
                                                        ...
                                                        <div class="col-md-12 mb-3">
                                                             ...
                                                             <div class="d-flex flex-wrap mt-2 sortable-images"
                                         ...
                                         <div class="text-end mt-3">
                                              <button type="button"
                                                   ...
                                                   class="btn btn-outline-primary mt-2 addVariant">
                                                   + Add Another Variant
                                              </button>
               ...
               $(document).ready(function() {
                          ...
                          =============================== */
                          var variantIndex = {{ count($variant) }};
