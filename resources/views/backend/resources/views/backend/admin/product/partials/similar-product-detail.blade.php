            ...
            <div class="variant-block border p-3 mb-4 rounded text-start">
                ...
                <div class="row g-3">
                    ...
                    <div class="col-md-6 mb-2">
                        ...
                        <select name="size_cat_id[]" class="form-control similerSelectSizeCategory">
                    ...
                    <div class="col-md-6">
                        <label>Sizes</label>
                        <select name="size[{{ $index }}][]" class="form-control update-size-select js-size-select" multiple>
