                ...
                <div class="card border-0 shadow-sm">
                    <div class="card-body p-4">
                            ...
                            <form action="{{ route('notification.setting.update') }}" method="POST">
                                ...
                                <div class="row g-4">
                                    <div class="col-md-12">
                                        <h5 class="mb-3 text-purple">OneSignal Configuration</h5>
                                    </div>

                                    <div class="col-md-6">
                                        <label class="form-label fw-bold">OneSignal App ID</label>
                                        <input type="text" name="onesignal_app_id" class="form-control" value="{{ $notification->onesignal_app_id ?? '' }}">
                                    </div>

                                    <div class="col-md-6">
                                        <label class="form-label fw-bold">OneSignal Rest API Key</label>
                                        <input type="password" name="onesignal_rest_api_key" class="form-control" value="{{ $notification->onesignal_rest_api_key ?? '' }}">
                                    </div>
                ...
                <div class="card border-0 shadow-sm rounded-4 bg-soft-purple">
                    <div class="card-body p-4">
                        ...
                        <ul class="text-muted fs-13 ps-3">
                            <li class="mb-2"><strong>OneSignal</strong> is used for cross-platform push notifications.</li>
                        ...
                        <div class="mt-4 pt-3 border-top border-purple border-opacity-10">
                            ...
                            <div class="d-flex flex-column gap-2">
                                <a href="https://onesignal.com/" target="_blank" class="text-purple fs-13 d-flex align-items-center gap-2">
                                    <iconify-icon icon="solar:link-linear"></iconify-icon> OneSignal Dashboard
                                </a>
