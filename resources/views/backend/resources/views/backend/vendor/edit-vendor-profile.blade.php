                        ...
                        <div class="card-body">
                            ...
                            <div class="d-flex gap-4">
                                <div class="form-check">
                                    ...
                                    <label class="form-check-label fw-medium" for="payout_weekly">Weekly</label>
                                    <div class="text-muted small">Payouts processed every week</div>
                                </div>
                                <div class="form-check">
                                    ...
                                    <label class="form-check-label fw-medium" for="payout_monthly">Monthly</label>
                                    <div class="text-muted small">Payouts processed every month</div>
                                </div>
                                <div class="form-check">
                                    ...
                                    <label class="form-check-label fw-medium" for="payout_daily">Daily Per-Order (Testing)</label>
                                    <div class="text-muted small">Payouts processed daily per delivered order</div>
                                </div>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="card">
                        <div class="card-body">
                            ...
                            <div class="row g-3">
                                ...
                                <div class="col-md-6">
                                    <label class="form-label">IBAN / SWIFT</label>
                                    <input type="text" name="ifsc_code" class="form-control" value="{{ old('ifsc_code', $vendor_data->ifsc_code) }}" placeholder="AE980234..">
                                </div>
                                <div class="col-12">
                                    ...
                                    <div class="p-3 border bg-light-subtle d-flex align-items-center justify-content-between">
                                        ...
                                        <a href="{{ $vendor_data->cancelled_cheque }}" target="_blank" class="btn btn-sm btn-outline-primary ms-2">
