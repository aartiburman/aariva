                    ...
                    <div class="card-body p-4">
                        <form id="createTicketForm" action="{{ route('tickets.store') }}" method="POST" enctype="multipart/form-data">
                            ...
                            <div class="mb-4">
                                ...
                                <textarea name="message" class="form-control border-light bg-light shadow-none" rows="6" placeholder="Please provide detailed information about your issue..." required></textarea>
                            </div>
                            ...
                            <div class="mb-4">
                                ...
                                <div class="border-dashed rounded-3 p-4 text-center cursor-pointer position-relative" style="border: 2px dashed #e9ebec; background-color: #f8f9fa;">
                                    ...
                                    <p class="mb-0 text-muted fs-12">Max size: 2MB. Allowed types: JPG, PNG, PDF, DOC</p>
                                </div>
                            </div>
    ...
    $(document).ready(function() {
        ...
        $('#ticketAttachment').on('change', function() {
            ...
            if(fileName){
                ...
                $('#attachmentLabel').addClass('text-success').removeClass('text-dark');
            } else {
