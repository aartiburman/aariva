...
<head>
    ...
    <style>
        ...
        .totals { margin-top: 20px; border-top: 1px solid #edf2f7; padding-top: 15px; }
        .total-row { display: flex; justify-content: space-between; margin-bottom: 5px; font-size: 14px; color: #4a5568; }
        .grand-total { 
            font-size: 20px; 
            font-weight: 700; 
            color: #1a1a1a; 
