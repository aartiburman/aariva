...
class FormAdvanced {
    ...
    initFormChoices() {
        ...
        choicesExamples.forEach(function (item) {
            if (item.classList.contains("choices-initialized")) return;
            ...
            item.classList.add("choices-initialized");
        });
    }
...
class ThemeLayout {
     ...
     changeThemeMode(color) {
          ...
          // Automatically switch topbar color to match theme
          this.changeTopbarColor(color);
